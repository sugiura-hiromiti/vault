...
- to_camel
- is_kebab
- [ ] #oso/feat create [build script](https://doc.rust-lang.org/cargo/reference/build-script-examples.html) [reference](https://doc.rust-lang.org/cargo/reference/build-scripts.html)(@[[2025-08-23]])