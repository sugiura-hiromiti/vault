...
- [ ] #fix clear default keybind of ghostty(@[[2025-08-11]])
- [ ] #nvim/fix disable statusline. use tabline instead(@[[2025-08-11]])
- [ ] #fix set primary modifier key to Super(cmd) in zellij(@[[2025-08-11]])
- [ ] #fix configure automatically attach last session of zellij on startup