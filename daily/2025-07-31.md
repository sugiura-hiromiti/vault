...
- [ ] ガス代支払い(@[[2025-07-31]] 19:00)
- [ ] #oso #add implement cargo workspace detection in `oso_dev_util`(@[[2025-07-31]] 20:00)
- [ ] #oso #add #xtask implement lint, build utility(@[[2025-07-31]] 19:00)
- [ ] #ai #fix fix `gac` waiting merging PR until