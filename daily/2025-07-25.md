...
- [ ] remove created & updated properties from frontmatter.
	- [x] use dataview [inline query](https://blacksmithgu.github.io/obsidian-dataview/annotation/metadata-pages/) like `this.file.ctime` instead(@[[2025-07-25]] 19:00)
- [ ] update yabairc
	...
	- [x] add rule/signal for connecting/disconnecting display(@[[2025-07-26]] 16:00)
