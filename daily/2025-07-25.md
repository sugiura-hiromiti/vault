...
- [ ] remove created & updated properties from frontmatter.
	- [x] use dataview [inline query](https://blacksmithgu.github.io/obsidian-dataview/annotation/metadata-pages/) like `this.file.ctime` instead(@[[2025-07-25]] 19:00) [completion:: 250726]
- [ ] update yabairc
